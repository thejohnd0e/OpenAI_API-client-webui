...
with gr.Blocks(css="#chatbot { height: 70vh !important; }") as demo:
    gr.Markdown("# Universal OpenAI Chat Client")
    ...
    def save_current_settings(profile_name, api_key, base_url, model, max_tokens, temperature, top_p, presence_penalty,
                              frequency_penalty):
        settings = {
            "api_key": api_key,
            "base_url": base_url,
    ...
    save_button.click(
        ...
        inputs=[profile_name, api_key, base_url, model, max_tokens, temperature, top_p, presence_penalty,
                frequency_penalty],
    ...
    load_button.click(
        ...
        outputs=[api_key, base_url, model, max_tokens, temperature, top_p, presence_penalty, frequency_penalty]
    )
